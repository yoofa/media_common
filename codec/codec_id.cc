...
CodecId MimeToCodecId(const char* mime) {
  ...
  //     return CodecId::AV_CODEC_ID_MIDI;
  //   }
  ...
  //     return CodecId::AV_CODEC_ID_AAC_ADTS;
  //   }
  ...
  //     return CodecId::AV_CODEC_ID_MSADPCM;
  //   }
  //   if (!strncasecmp(MEDIA_MIMETYPE_AUDIO_DVI_IMA_ADPCM, mime, strlen(mime)))
  //   {
  //     return CodecId::AV_CODEC_ID_DVI_IMA_ADPCM;
  //   }
  // UNKNOWN
...
const char* CodecIdToMime(CodecId codec_id) {
  switch (codec_id) {
    ...
    case CodecId::AV_CODEC_ID_HEVC:
      return MEDIA_MIMETYPE_VIDEO_HEVC;
    case CodecId::AV_CODEC_ID_MPEG4:
      return MEDIA_MIMETYPE_VIDEO_MPEG4;
    case CodecId::AV_CODEC_ID_H263:
      return MEDIA_MIMETYPE_VIDEO_H263;
    case CodecId::AV_CODEC_ID_MPEG2VIDEO:
      return MEDIA_MIMETYPE_VIDEO_MPEG2;
    case CodecId::AV_CODEC_ID_RAWVIDEO:
      return MEDIA_MIMETYPE_VIDEO_RAW;
    case CodecId::AV_CODEC_ID_MJPEG:
      return MEDIA_MIMETYPE_VIDEO_MJPEG;
    case CodecId::AV_CODEC_ID_AMR_NB:
      return MEDIA_MIMETYPE_AUDIO_AMR_NB;
    case CodecId::AV_CODEC_ID_AMR_WB:
      return MEDIA_MIMETYPE_AUDIO_AMR_WB;
    case CodecId::AV_CODEC_ID_MP3:
      return MEDIA_MIMETYPE_AUDIO_MPEG;
    case CodecId::AV_CODEC_ID_MP2:
      return MEDIA_MIMETYPE_AUDIO_MPEG_LAYER_II;
    case CodecId::AV_CODEC_ID_AAC:
      return MEDIA_MIMETYPE_AUDIO_AAC;
    case CodecId::AV_CODEC_ID_QCELP:
      return MEDIA_MIMETYPE_AUDIO_QCELP;
    case CodecId::AV_CODEC_ID_VORBIS:
      return MEDIA_MIMETYPE_AUDIO_VORBIS;
    case CodecId::AV_CODEC_ID_OPUS:
      return MEDIA_MIMETYPE_AUDIO_OPUS;
    case CodecId::AV_CODEC_ID_PCM_ALAW:
      return MEDIA_MIMETYPE_AUDIO_G711_ALAW;
    case CodecId::AV_CODEC_ID_PCM_MULAW:
      return MEDIA_MIMETYPE_AUDIO_G711_MLAW;
    case CodecId::AV_CODEC_ID_FLAC:
      return MEDIA_MIMETYPE_AUDIO_FLAC;
    case CodecId::AV_CODEC_ID_GSM_MS:
      return MEDIA_MIMETYPE_AUDIO_MSGSM;
    case CodecId::AV_CODEC_ID_AC3:
      return MEDIA_MIMETYPE_AUDIO_AC3;
    case CodecId::AV_CODEC_ID_EAC3:
      return MEDIA_MIMETYPE_AUDIO_EAC3;
    case CodecId::AV_CODEC_ID_ALAC:
      return MEDIA_MIMETYPE_AUDIO_ALAC;
    case CodecId::AV_CODEC_ID_WMAV1:
